...
public class MailUtils {
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        String[] ss = {"907471325@qq.COM" };

        sendTextWithHtml(initJavaMailSender(), ss, "测试简单文本邮件发送！ ", " <a href='http://work.dev.gomeplus.com/' C=1 A=3>test</a>测试我的简单邮件发送机制！！ ");
    ...
    public static JavaMailSenderImpl initJavaMailSender() {
        ...
        javaMailSender.setUsername("isflag@126.com"); // s根据自己的情况,设置username
        javaMailSender.setPassword("messi1"); // 根据自己的情况, 设置password
